...
namespace Joy\VoyagerBreadLineItem\Models;
...
use Joy\VoyagerBreadLineItem\Database\Factories\LineItemFactory;
...
class LineItem extends Model
{
    ...
    {
        return $this->belongsTo(Voyager::modelClass('LineItem'));
    }
